...
dependencies {
    ...
    implementation("net.jsign:jsign-core:4.2")
}
    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                ...
                description.set("Authenticode verification implementation in java")
                url.set("https://github.com/jc-lab/jverify")
                licenses {
                    license {
                ...
                scm {
                    connection.set("scm:git:https://github.com/jc-lab/jverify.git")
                    developerConnection.set("scm:git:ssh://git@github.com/jc-lab/jverify.git")
                    url.set("https://github.com/jc-lab/jverify")
                }
            }
        }
